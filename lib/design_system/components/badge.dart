  ...
  Map<String, Color> _getVariantColors() {
    switch (variant) {
      case BadgeVariant.success:
        return {
          'background': ColorPalette.ratingExcellent.withOpacity(0.1),
          'text': ColorPalette.ratingExcellent,
        };
      case BadgeVariant.warning:
        return {
          'background': ColorPalette.ratingSatisfactory.withOpacity(0.1),
          'text': ColorPalette.ratingSatisfactory,
        };
      case BadgeVariant.error:
        return {
          'background': ColorPalette.ratingNeedsImprovement.withOpacity(0.1),
          'text': ColorPalette.ratingNeedsImprovement,
        };
      case BadgeVariant.info:
        return {
          'background': ColorPalette.primaryDark.withOpacity(0.1),
...
class AlifStatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final backgroundColor = isActive
        ? (activeColor ?? ColorPalette.ratingExcellent).withOpacity(0.1)
