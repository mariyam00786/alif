...
class _AlifInputState extends State<AlifInput> {
      ...
      children: [
        ...
        Focus(
          ...
          child: TextFormField(
            ...
            minLines: widget.minLines ?? (widget.type == InputType.multiline ? 4 : 1),
            textInputAction: widget.textInputAction,
            textDirection: widget.isMalayalam ? TextDirection.rtl : TextDirection.ltr,
            style: widget.textStyle ??
                TypographySystem.bodyText.copyWith(
                  color: widget.isDisabled ? ColorPalette.neutral500 : ColorPalette.textPrimary,
                ),
  ...
  InputDecoration _buildDecoration() {
    ...
    return InputDecoration(
      ...
      filled: true,
      fillColor: widget.isDisabled ? ColorPalette.neutral100 : ColorPalette.white,
  ...
  void _validateInput(String value) {
    ...
    if (widget.minLength != null && value.isNotEmpty && value.length < widget.minLength!) {
