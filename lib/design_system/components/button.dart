    ...
    switch (widget.variant) {
      case ButtonVariant.primary:
        return {
          ...
          'hover': Color.fromARGB(
            255,
            (ColorPalette.primaryDark.red * 0.9).toInt(),
            (ColorPalette.primaryDark.green * 0.9).toInt(),
            (ColorPalette.primaryDark.blue * 0.9).toInt(),
          ),
      ...
      case ButtonVariant.secondary:
        return {
          ...
          'hover': Color.fromARGB(
            255,
            (ColorPalette.secondary.red * 0.9).toInt(),
            (ColorPalette.secondary.green * 0.9).toInt(),
            (ColorPalette.secondary.blue * 0.9).toInt(),
          ),
