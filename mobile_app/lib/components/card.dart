    ...
    return Column(
      ...
      children: [
        ...
        if (widget.header != null) ...[
          Padding(padding: padding, child: widget.header!),
        ...
        if (widget.footer != null) ...[
          ...
          Padding(padding: padding, child: widget.footer!),
        ],
      ],
    );
  }
...
class AlifCardBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlifCard(
      ...
      child: Row(
        children: [
          if (leading != null) ...[leading!, SizedBox(width: SpacingScale.md)],
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
  ...
  Widget build(BuildContext context) {
    return AlifCard(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, color: iconColor ?? ColorPalette.primaryDark, size: 32),
