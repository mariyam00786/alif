      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 10, color: ColorPalette.neutral600),
          ),
          if (subtitle != null) ...[
            Text(
              subtitle,
              style: TextStyle(fontSize: 9, color: ColorPalette.neutral500),
            ),
          ],
        ],
      ),
  ...
  Widget _buildActivityProgress() {
    return Row(
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            color: ColorPalette.primaryDark.withValues(alpha: 0.1),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                if (icon != null) Icon(icon, size: 16, color: progressColor),
              ],
            ),
            SizedBox(height: SpacingScale.sm),
            Row(
